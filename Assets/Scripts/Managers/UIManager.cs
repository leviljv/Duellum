...
public class UIManager : MonoBehaviour {
    ...
    private void OnEnable() {
        ...
        EventManager<BattleEvents>.Subscribe(BattleEvents.BattleEnd, BattleEnd);
    }
    private void OnDisable() {
        ...
        EventManager<BattleEvents>.Unsubscribe(BattleEvents.BattleEnd, BattleEnd);
    }
    ...
    private void BattleEnd() {
        //hmm this prob shouldn't be here actually
    }
}
